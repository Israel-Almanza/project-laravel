<div class="row g-4" wire:key="provincia-manager-root">
    <div class="col-md-3">
        <div class="card module-form-card shadow-sm border-0 h-100">
            ...
            <div class="card-body p-3 bg-white rounded-bottom">
                ...
                <div class="mb-3">
                    <label for="prov-depto-id" class="form-label small text-muted text-uppercase fw-semibold">{{ __('Departamento') }}</label>
                    <select id="prov-depto-id" wire:model="departamento_id" class="form-select rounded-3 @error('departamento_id') is-invalid @enderror">
                                    ...
                                    <td class="text-end pe-3">
                                        ...
                                        @else
                                            <div class="d-inline-flex gap-1 justify-content-end">
                                                <button type="button" wire:click="edit({{ $prov->id }})" class="btn btn-light btn-icon border shadow-sm" title="{{ __('Editar') }}">
                                                    <i class="fa-solid fa-pen text-secondary"></i>
                                                </button>
                                                <button type="button" wire:click="askDelete({{ $prov->id }})" class="btn btn-light btn-icon border shadow-sm" title="{{ __('Eliminar') }}">

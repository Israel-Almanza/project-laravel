<div class="row g-3" wire:key="departamento-manager-root">
    <div class="col-md-2">
        <div class="card module-form-card border-0 h-100">
            ...
            <div class="card-body p-3 bg-white rounded-bottom">
                ...
                <div class="mb-3">
                    <label for="dept-nombre" class="form-label small text-muted fw-semibold">{{ __('Departamento o Estado') }}</label>
                    <input type="text" id="dept-nombre" wire:model="nombre" class="form-control form-control-sm rounded-3 @error('nombre') is-invalid @enderror" placeholder="{{ __('Mendoza') }}">
                    @error('nombre')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    <label for="dept-pais-id" class="form-label small text-muted fw-semibold">{{ __('País') }}</label>
                    <select id="dept-pais-id" wire:model="pais_id" class="form-select form-select-sm rounded-3 @error('pais_id') is-invalid @enderror">
                                    ...
                                    <td class="text-end pe-2">
                                        ...
                                        @else
                                            <div class="d-inline-flex gap-1 justify-content-end">
                                                ...
                                                <!-- Editar -->
                                                <button type="button" wire:click="edit({{ $depto->id }})"
                                                ...
                                                <button type="button" wire:click="askDelete({{ $depto->id }})"
                                                    class="btn btn-light p-0 d-flex align-items-center justify-content-center"
